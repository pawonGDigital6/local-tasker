...
$price_per_sqm_ex  = ( $carton_sqm > 0 ) ? $price_ex / $carton_sqm : 0;
$price_per_sqm_inc = $price_per_sqm_ex * 1.10;

$spec_fields = [
	'Price'                 => $price_per_sqm_ex > 0
		? wc_price( $price_per_sqm_ex ) . ' <span class="text-lt-text-muted font-normal text-caption-xs">ex GST</span> <span class="text-lt-text-muted font-normal text-caption-xs">' . sprintf( __( '(incl. GST %s)', 'local-tasker' ), wc_price( $price_per_sqm_inc ) ) . '</span>'
		: '',
