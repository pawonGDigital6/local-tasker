...
acf_add_local_field_group( [
	...
	'fields'   => [
		...
		[
			'key'          => 'field_lt_install_rate',
			'label'        => 'Installation Rate (per sqm, ex GST)',
			'name'         => 'install_rate_per_sqm',
			'type'         => 'number',
			'instructions' => 'Leave 0 to hide the Purchase & Install option.',
			'prepend'      => '$',
			'append'       => '/ sqm ex GST',
			'min'          => 0,
			'step'         => 0.01,
		...
		[
			'key'         => 'field_lt_spec_dimension',
			'label'       => 'Dimension',
			'name'        => 'spec_dimension',
			'type'        => 'text',
			'placeholder' => 'e.g. 600mm × 125mm × 10mm',
			'wrapper'     => [ 'width' => '50' ],
		],
		[
			'key'         => 'field_lt_spec_veneer',
			'label'       => 'Veneer',
			'name'        => 'spec_veneer',
			'type'        => 'text',
			'placeholder' => 'e.g. 4mm European Oak',
			'wrapper'     => [ 'width' => '50' ],
		],
		[
			'key'         => 'field_lt_spec_finish',
			'label'       => 'Finish',
			'name'        => 'spec_finish',
			'type'        => 'text',
			'placeholder' => 'e.g. German Träffer UV Lacquer Matte Finish with Wire Brushed',
			'wrapper'     => [ 'width' => '50' ],
		],
		[
			'key'         => 'field_lt_spec_packaging_qty',
			'label'       => 'Packaging QTY',
			'name'        => 'spec_packaging_qty',
			'type'        => 'text',
			'placeholder' => 'e.g. 15 pcs (3.240 m² Per Box)',
			'wrapper'     => [ 'width' => '50' ],
		],
		[
			'key'         => 'field_lt_spec_packaging_weight',
			'label'       => 'Packaging Weight',
			'name'        => 'spec_packaging_weight',
			'type'        => 'text',
			'placeholder' => 'e.g. 12 KGS',
			'wrapper'     => [ 'width' => '50' ],
		],
		[
			'key'         => 'field_lt_spec_bevel',
			'label'       => 'Bevel',
			'name'        => 'spec_bevel',
			'type'        => 'text',
			'placeholder' => 'e.g. Micro-bevel',
			'wrapper'     => [ 'width' => '50' ],
		],
		[
			'key'         => 'field_lt_spec_profile',
			'label'       => 'Profile',
			'name'        => 'spec_profile',
			'type'        => 'text',
			'placeholder' => 'e.g. T&G',
		...
		[
			'key'         => 'field_lt_spec_formaldehyde',
			'label'       => 'Formaldehyde Emission',
			'name'        => 'spec_formaldehyde',
			'type'        => 'text',
			'placeholder' => 'e.g. E0',
			'wrapper'     => [ 'width' => '50' ],
		],
		[
			'key'         => 'field_lt_spec_sustainability',
			'label'       => 'Sustainability',
			'name'        => 'spec_sustainability',
			'type'        => 'text',
			'placeholder' => 'e.g. Forest Stewardship Council® (FSC®)',
			'wrapper'     => [ 'width' => '50' ],
		],
		[
			'key'         => 'field_lt_spec_warranty',
			'label'       => 'Warranty',
			'name'        => 'spec_warranty',
			'type'        => 'textarea',
			'rows'        => 3,
			'placeholder' => 'e.g. Lifetime Structural Warranty · 25 Years Limited Residential Surface Warranty…',
		],
	],
	'location' => [
