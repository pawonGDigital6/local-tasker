...
/* harmony import */ var _components_area_calculator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/area-calculator */ "./src/global/js/components/area-calculator.js");
/**
...
(function () {
  ...
  ══════════════════════════════════════════════════════════ */
  (0,_components_area_calculator__WEBPACK_IMPORTED_MODULE_2__.initAreaCalculators)();
  ...
  if (calcWrap && cartonSqm > 0) {
    ...
    function compute() {
      ...
      const boxes = effective > 0 ? roundUp ? Math.ceil(effective / cartonSqm) : Math.floor(effective / cartonSqm) : 0;
  ...
  if (relatedSlider) {
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](relatedSlider, {
      speed: 400,
      spaceBetween: 20,
      slidesPerView: 1,
      breakpoints: {
