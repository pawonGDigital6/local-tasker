...
function relatedCarousel() {
  ...
  document.querySelectorAll(".related-post").forEach(container => {
    ...
    const swiper1 = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](container.querySelector(".related-post-carousel"), {
      speed: 500,
      spaceBetween: 16,
      slidesPerView: 1.26,
      pagination: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (relatedCarousel);
...
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_0___default()(() => {
  ...
  (0,_components_global_carousel__WEBPACK_IMPORTED_MODULE_3__["default"])();
});
