/******/ (() => { // webpackBootstrap
/*!************************************************!*\
  !*** ./src/blocks/project-with-filter/view.js ***!
  \************************************************/
/**
...
(function () {
  ...
  class ProjectsFilter {
    ...
    constructor(blockEl) {
      ...
      this.ajaxUrl = window.pwfData?.ajaxUrl ?? window.bwfData?.ajaxUrl ?? "/wp-admin/admin-ajax.php";
    ...
    _setLoadingState(isLoading, viewAll) {
      ...
      if (this.viewAllBtn) {
        ...
        if (isLoading && viewAll) {
          this.viewAllBtn.dataset.originalText = this.viewAllBtn.textContent.trim();
          this.viewAllBtn.textContent = "Loading…";
        } else if (!isLoading) {
          this.viewAllBtn.textContent = this.viewAllBtn.dataset.originalText || "View All Projects";
        }
      }
  ...
  function init() {
    document.querySelectorAll(".acf-block.lt-projects").forEach(blockEl => new ProjectsFilter(blockEl));
  }
