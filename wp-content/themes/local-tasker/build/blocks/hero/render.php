...
<section <?php echo esc_attr($anchor); ?> class="<?php echo esc_attr($class_name); ?>" <?php echo $style_attr; ?>>
    <!-- Abs BG image  -->
    <div class="abs-bg-img absolute inset-0 object-cover">
        <?php
        if ($hero_image) {
...
"></div>
    <div class="container relative">
        <!-- Pre Heading -->
        <div class="pre-header flex max-sm:flex-col sm:gap-4 gap-1 items-center text-center justify-center sm:mb-[1.85rem] mb-[1.25rem]">
            ...
            <!-- Pre Title -->
            <?php if ($pre_title): ?>
                <span class="text-white text-caption-md [&_*:last-child]:mb-0 [&_strong]:font-semibold"><?php echo $pre_title; ?></span>
            <?php endif; ?>
            
        </div>
        <!-- Hero Title -->
        <?php if ($hero_title): ?>
            <h1 class="hero-title text-white text-center font-bold max-w-[892px] mx-auto leading-none font-semi-ext max-md:leading-[1.23]">
                ...
                <?php while (have_rows('features_item')):
                    ...
                    <div class="feature-list__item text-center text-lt-white">
                        ...
                        <?php if ($feature_title): ?>
                            <h2 class="feature-heading text-body-xl leading-[1.4] font-bold tracking-[-0.8px] font-semi-ext sm:mb-[11px] mb-2"><?php echo esc_html($feature_title); ?></h2>
                        <?php endif; ?>
                        <?php if ($feature_text): ?>
