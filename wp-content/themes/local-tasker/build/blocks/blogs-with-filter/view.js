/******/ (() => { // webpackBootstrap
/*!**********************************************!*\
  !*** ./src/blocks/blogs-with-filter/view.js ***!
  \**********************************************/
/**
...
(function () {
    ...
    _setLoadingState(isLoading) {
      ...
      if (this.loadMoreBtn) {
        ...
        if (isLoading) {
          ...
          this.loadMoreBtn.dataset.originalText = this.loadMoreBtn.textContent.trim();
          this.loadMoreBtn.textContent = "Loading\u2026"; // "Loading…"
        } else {
          this.loadMoreBtn.textContent = this.loadMoreBtn.dataset.originalText || "Load More Articles";
        }
      }
   ...
   */
  function init() {
    document.querySelectorAll(".acf-block.lt-blogs-filter").forEach(blockEl => new BlogsFilter(blockEl));
  }
