...
(() => {
/*!***************************************************!*\
  !*** ./src/blocks/services-installations/view.js ***!
  \***************************************************/
__webpack_require__.r(__webpack_exports__);
...
document.querySelectorAll(".lt-service-installation").forEach(container => {
  ...
  const swiper1 = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](container.querySelector(".lt-left-slide"), {
    speed: 500,
    spaceBetween: 24,
    slidesPerView: 1,
    pagination: {
  ...
  const swiper2 = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](container.querySelector(".lt-right-slide"), {
    speed: 500,
    spaceBetween: 24,
    slidesPerView: 1,
    navigation: {
